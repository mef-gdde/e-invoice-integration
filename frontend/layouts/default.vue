...
const activeClass = (link) => {
    return {
    'hover:bg-cyan-400 text-cyan-100': route.name !== link,
    'bg-cyan-300 shadow-lg text-white': route.name == link,
    }
}
</script>
<template>
    <div class="hide-print flex flex-row h-screen antialiased text-blue-gray-800">
        ...
        <div class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
            ...
            <li>
                ...
                >
                    <span class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-12 w-12 rounded-2xl" :class="activeClass('invoice')">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 22" class="nuxt-icon nuxt-icon--fill h-6 w-6 mt-0.5"><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M7.505 1.75h6.903c3.451 0 4.31.884 4.3 4.41v5.098a6 6 0 0 0-7.344 7.919c-.61.172-1.274-.043-1.75-.645l-.922-1.18c-.648-.832-1.79-.893-2.538-.132l-.01.009C4.53 18.89 3.197 18.34 3.197 16.013V6.16c0-3.526.858-4.41 4.31-4.41Zm.712 8.531h5.479c.374 0 .684-.297.684-.656 0-.359-.31-.656-.684-.656H8.217c-.374 0-.684.297-.684.656 0 .359.31.656.684.656Zm-.913-3.5h7.305c.374 0 .684-.297.684-.656 0-.359-.31-.656-.684-.656H7.304c-.374 0-.685.297-.685.656 0 .359.31.656.685.656Z"></path><path d="M16.956 12a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm-.288 3.076-1.591 1.607a.42.42 0 0 0 .005.594c.16.162.421.162.582 0l.882-.896v2.699a.413.413 0 1 0 .826 0v-2.7l.882.897c.16.162.421.162.582 0a.426.426 0 0 0 0-.594l-1.586-1.607a.43.43 0 0 0-.294-.124.43.43 0 0 0-.288.123Z"></path></g></svg>
                    </span>
                </NuxtLink>
            </li>
            <li>
                <NuxtLink to="/invoice-received"
                class="flex items-center">
                <span class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-12 w-12 rounded-2xl"
                    :class="activeClass('invoice-received')"
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 22" class="nuxt-icon nuxt-icon--fill h-6 w-6 mt-0.5"><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M7.505 1.75h6.903c3.451 0 4.31.884 4.3 4.41v5.098a6 6 0 0 0-7.344 7.919c-.61.172-1.274-.043-1.75-.645l-.922-1.18c-.648-.832-1.79-.893-2.538-.132l-.01.009C4.53 18.89 3.197 18.34 3.197 16.013V6.16c0-3.526.858-4.41 4.31-4.41Zm.712 8.531h5.479c.374 0 .684-.297.684-.656 0-.359-.31-.656-.684-.656H8.217c-.374 0-.684.297-.684.656 0 .359.31.656.684.656Zm-.913-3.5h7.305c.374 0 .684-.297.684-.656 0-.359-.31-.656-.684-.656H7.304c-.374 0-.685.297-.685.656 0 .359.31.656.685.656Z"></path><path d="M16.956 22a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm.29-3.076 1.59-1.607a.42.42 0 0 0-.005-.594.409.409 0 0 0-.582 0l-.882.896V14.92a.413.413 0 1 0-.826 0v2.7l-.882-.897a.409.409 0 0 0-.582 0 .426.426 0 0 0 0 .594l1.586 1.607a.43.43 0 0 0 .294.124.43.43 0 0 0 .288-.123Z"></path></g></svg>
                </span>
                </NuxtLink>
            </li>
            <li>
                ...
                class="flex items-center">
                <span class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-12 w-12 rounded-2xl"  :class="activeClass('setting')">
                    <svg class="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
